                    ...
                    data.forEach(function(submission) {
                        ...
                        submission._attachments.forEach(function(attachment) {
                            ...
                            if(attachment.mimetype.startsWith('image')){
                                var media_object = {'media_name':media_name,'media_path':media_path,'media_count':image_count};
                                image_list.push(media_object);
                                image_set.add(image_count);
                                image_count += 1 ;
                            }else if(attachment.mimetype.startsWith('audio')){
                                var media_object = {'media_name':media_name,'media_path':media_path,'media_count':audio_count,'mimetype':attachment.mimetype};
                                audio_list.push(media_object);
                                audio_set.add(audio_count);
                                audio_count += 1 ;
                            }
                        });
                    });
