...
urlpatterns = patterns('',
    ...
    url(r'^get_events_forms_list/$', views.get_events_forms_list, name='get_events_forms_list'),
    ...
    url(r'^delete_case/(?P<victim_tbl_id>\d+)/$', views.delete_case, name='delete_case'),
