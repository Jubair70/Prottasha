...
from onadata.apps.usermodule.models import RSC,UserModuleProfile, UserPasswordHistory,Organizations,OrganizationDataAccess,MenuItem
...
class UserProfileForm(forms.ModelForm):
    ...
    organisation_name = forms.ModelChoiceField(label='Organisation Name',queryset=Organizations.objects.all(),empty_label="Select an Organization",required=True)

    rsc_name = forms.ModelChoiceField(label='RSC Name', queryset=RSC.objects.all(),
                                               empty_label="Select an RSC",required=False)
    ...
    class Meta:
        ...
        fields = (
        'admin', 'organisation_name', 'designation', 'contact_number','rsc_name')
