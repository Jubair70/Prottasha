...
def edit_data(request, username, id_string, data_id):
    ...
    return render(request, 'formbuilder_form.html',{'username':username,'server_address':server_address,'form_id':form_id,'form_builder_server':form_builder_server,'instance_id':instance_id,'redirected_url':redirected_url})
