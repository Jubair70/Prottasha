...
class GenerateDashboard:
    ...
    def skeleten_content(self,leaf_data):
        ...
        tab_content_skeleton = """
                      ...
                      <div class ="row">
                        <div class ="row" style="">
                        <div  class="col-md-12"  id="toggle_right_{leaf_id}" onclick="openNav('right_{leaf_id}',this);" style=""  >
                        ...
                        <div id = "filter_right_{leaf_id}" >
                            <div class = "mpower-section right sidenav sidenav_right" id="right_{leaf_id}" >
