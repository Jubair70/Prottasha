...
class Graph(Component):
	...
	tab_title =''
        if "head" in appearance:
            ...
            tab_title = "<div class='portlet-title'><center>" + appearance["head"] + "</center></div>"
...
class Cards(Component):
    ...
    def execute(self):
        ...
        self.chart_html += """
                    <div  style="width:{width}%"  class="middle-item ">
                    {tab_title}
                        <div id="{element_id}" class = "dashboard-stat blue" style="min-height: 120px;"></div>

                    </div>
                    """.format(width=width,tab_title=tab_title, element_id=self.chart_def.element_id)
