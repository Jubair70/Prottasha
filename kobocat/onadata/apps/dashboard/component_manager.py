...
class ComponentManager:
    ...
    def get_chart_content(self):
        ...
        #for appending elements row wise
        for i in range(max_content_row+1):
            #considering every row will have one head Title
            row_start= '<div class="row collapse in" id = "row_'+str(i)+'">'
            
            for c in self.components:
                if c.row==i:
                    jsondata = c.execute()
                    if row_head_html== '':
                        row_head_html = jsondata['head_html']
                    
                    row_json_html += jsondata['chart_html']
            ...
            row_end = '</div>'
            self.chart_html += row_head_html+row_start+row_json_html+row_end
            row_head_html = ''
            row_json_html = ''
...
class Graph(Component):
	...
	tab_title =''
        if "head" in appearance and appearance["head"]!='':
            head_title = '<a  class="accordion-toggle" data-toggle="collapse" href="#row_'+ str(self.chart_def.content_row)+'"><b>'+ appearance["head"]+'</b></a>'
            tab_title = "<div class='portlet-title' >" + head_title + "</div>"

        self.head_html = tab_title
        ...
        return {'head_html':self.head_html,'chart_html': self.chart_html, 'js_chart_calling_function': self.js_chart_calling_function, 'js_chart_calling_function_with_param': self.js_chart_calling_function_with_param}
...
class SimpleTable(Component):
    ...
    def execute(self):
        ...
        return {'head_html':self.head_html,'chart_html': self.chart_html, 'js_chart_calling_function': self.js_chart_calling_function,
                'js_chart_calling_function_with_param': self.js_chart_calling_function_with_param}
...
class SimpleMap(Component):
    ...
    def execute(self):
        ...
        tab_title =''
        if "head" in appearance and appearance["head"]!='':
            head_title = '<a  class="accordion-toggle" data-toggle="collapse" href="#row_'+ str(self.chart_def.content_row)+'">'+ appearance["head"]+'</a>'
            tab_title = "<div class='portlet-title' >" + head_title + "</div>"
