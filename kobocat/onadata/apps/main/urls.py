...
urlpatterns = patterns(
    ...
    url(r'^asf/', include('onadata.apps.asfmodule.urls', namespace="asfmodule")),
    ...
    url(r'^inventory/', include('onadata.apps.inventory.urls', namespace="inventory",app_name="inventory")),
...
url(r"^(?P<username>\w+)/get_all_csv",
    ...
    url(r"^xformsMedia/(?P<pk>[\d+^/]+)/(?P<metadata>[\d+^/.]+)\."
        ...
        XFormListApi.as_view({'get': 'media'}), name='xform-media'),
    #url(r"^(?P<username>\w+)/submission$",
    #    XFormSubmissionApi.as_view({'post': 'create', 'head': 'create','options':'create'}),
    #    name='submissions'),
