...
urlpatterns = patterns('',
    ...
    url(r'^get_returnee_list/$', views_api.get_returnee_list, name='get_returnee_list'),
    url(r'^get_returnee_form/$', views_api.get_returnee_form, name='get_returnee_form'),
    url(r'^get_returnee_info/$', views_api.get_returnee_info, name='get_returnee_info'),
