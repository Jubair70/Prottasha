...
urlpatterns = patterns('',
    ...
    url(r'^show_graph_def_get_json/(?P<nav_id>\d+)/$', views.show_graph_def_get_json, name='show_graph_def_get_json'),
    url(r'^delete_graph_def/(?P<graph_id>\d+)/$', views.delete_graph_def, name='delete_graph_def'),
    url(r'^edit_graph_def/(?P<graph_id>\d+)/$', views.edit_graph_def, name='edit_graph_def'),
    url(r'^save_dashboard_style/$', views.save_dashboard_style, name='save_dashboard_style'),
    url(r'^edit_dashboard_style/$', views.edit_dashboard_style, name='edit_dashboard_style'),
